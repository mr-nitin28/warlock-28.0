      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-5 gap-8 sm:gap-12 items-start mb-16 sm:mb-20 lg:mb-24">
            {/* Profile Image Section - Minimal Animation */}
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              <div className="relative max-w-sm sm:max-w-md mx-auto">
                ...
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-primary rounded-3xl blur-2xl opacity-20 scale-105" />
            ...
            >
              ...
              {/* Skills Highlights - Minimal Stagger */}
                ...
                {[
                  ...
                  return (
                    <motion.div
                      ...
                      className="glassmorphism rounded-lg sm:rounded-xl p-4 sm:p-6 text-center border border-white/10 hover:border-primary/30 transition-colors duration-300 cursor-pointer"
                    >
                      <div className="mb-2 sm:mb-3">
                        <IconComponent className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-primary drop-shadow-lg" />
                      </div>
                      <h4 className="font-bold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">{strength.title}</h4>
                      <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">{strength.desc}</p>
                    </motion.div>
                  );
                })}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                ...
                <Button
                  variant="outline"
                  className="w-full sm:w-auto glassmorphism hover:bg-primary/10 border-primary/30 hover:border-primary/40 transition-all duration-300"
          ...
          <div className="relative">
            ...
            {timeline.map((item, index) => (
              <motion.div
                ...
                className={`relative flex items-center mb-8 sm:mb-12 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''
                  }`}
              >
                {/* Timeline Dot - Simple */}
                <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-6 sm:w-8 h-6 sm:h-8 bg-gradient-primary rounded-full border-3 sm:border-4 border-background z-10 flex items-center justify-center shadow-lg shadow-primary/50">
